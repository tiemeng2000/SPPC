    ...
    $.LeapG.Pointer = function (){
        ...
        this._createCursor = function(){
            ...
            this.cursor.css({           //细化cursor样式
                'display': 'block',
                'background-image': 'url(js/leapjs-MouseHands/css/cursor_0.1_rhand.png)',
        ...
        this.onHandPinch = function(){
            ...
            this.cursor.empty();
            this.cursor.css({'background-image': 'url(js/leapjs-MouseHands/css/cursor_0.3_rhand_fist.png)'});
        ...
        this.onHandUnpinch = function(){
            this.cursor.css({'background-image': 'url(js/leapjs-MouseHands/css/cursor_0.1_rhand.png)'});
            this.tips.remove();
        ...
        this.onHandPointing = function(){
        	this.cursor.css({'background-image': 'url(js/leapjs-MouseHands/css/cursor_0.3_rhand_pointing.png)'});
        ...
        this.onHandTapStart = function(){
            ...
            tmpCs.css({'background-image': 'url(js/leapjs-MouseHands/css/cursor_0.3_rhand_tap.png)'});
