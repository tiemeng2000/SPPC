 ...
 * 改变：1、删除flag_pinch全局变量及状态变量，改用$(element)的attr变量status_pinch
 *      2、删除flag_mousedown全局变量，改用$(element)的attr变量status_pinch的singlePinched判断
 *      
 */
...
(function($){
    ...
    $.gInit = function (){
        ...
        controller.on('frame', function (frame){
            ...
            frame.hands.forEach ( function (hand, index){
                ...
                //console.log("pinchEle[index]: ",pinchEle[index]);
            });
        });     
    ...
    $.gTriggerEvent_MouseMove = function (visualCursor, currCursorPosition, prevCursorPosition){
        ...
        else if( $(element).attr("status_pinch") === "SINGLE_PINCHED" ){
    ...
    $.gTriggerEvent_Hover = function (visualCursor, prevCursorPosition, currCursorPosition){
        ...
        if ( (eleCurr != elePrev) && (visualCursor.isPinching === false) ){
            console.log(visualCursor.isPinching);
