 ...
 * 改变：1、triggerDOMEvent中 $.trigger改为JS原生dispatch过程
 */
...
(function($){
    ...
    $.LeapG.Pointer = function (){
        ...
        //DOM元素事件触发
        this.triggerDOMEvent = function(event_name, event_type){
            ...
            switch (event_type){
                case "MouseEvent":
                    ...
                    //evt.initMouseEvent( event_name, true, true, document.defaultView,
                                       // null, 0, 0, 0, 0, false, false, false, false, 0, null);
                case "CustomEvent":
                    evt = $.Event(event_name);
        ...
        this.onPointerMove = function (){
            ...
            return this.triggerDOMEvent("mousemove", "MouseEvent");
        }

        //响应函数：onPointerEnter
        this.onPointerEnter = function (){
            return this.triggerDOMEvent("mouseenter", "MouseEvent");
        }
        ...
        this.onPointerLeave = function (){
            ...
            evt.clientX = (this.prevPos === null) ? 0 : this.prevX;
            evt.clientY = (this.prevPos === null) ? 0 : this.prevY;
            this.cursor.hide();
