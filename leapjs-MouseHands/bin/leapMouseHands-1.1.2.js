/*
 * 2015-12-27 *
 * 增加：1、LeapMotion自带gesture识别
 *      2、Controller的onGesture响应函数
        3、没有hands数据时，删除pointer
        4、Pointer.removePointer()
        
 * 改变：1、该pointers对象为数组
 *      2、(未使用)leapToScene中改pip和mcp，用stabilizedTipPosition，从而增加pointer的位置稳定性
 */
